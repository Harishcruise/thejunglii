  ...
  return (
    <div style={{backgroundColor:"#000000",display:"flex",flexDirection:"column"}}>
      <div className={Style.section1}>
        ...
        <div className={Style.imgContainer}><img className={Style.img} src="https://img1.wsimg.com/isteam/ip/3b365560-5245-47cc-b9ac-77e98d410987/2018-10-26.jpg/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1160,h:1160" alt=""/></div>
